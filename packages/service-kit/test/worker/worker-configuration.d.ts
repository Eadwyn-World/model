/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=test/worker/wrangler.jsonc test/worker/worker-configuration.d.ts` (hash: 1de1701c330d9498e941840d855a5680)
// Runtime types generated with workerd@1.20260921.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	PROBE: DurableObjectNamespace<import("./index").StoreProbe>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "StoreProbe";
	}
