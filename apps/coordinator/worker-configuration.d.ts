/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9f69a60a5eb5fdfb6f4b5ef69f4fdab4)
// Runtime types generated with workerd@1.20260921.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	SEED_MODE: "genesis";
	LOG_LEVEL: "info";
	COORDINATOR_EXPECTED_NODES: "16";
	COORDINATOR_ONLINE_WINDOW_MINUTES: "360";
	FEDERATION: DurableObjectNamespace<import("./src/worker/index").Federation>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "Federation";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SEED_MODE" | "LOG_LEVEL" | "COORDINATOR_EXPECTED_NODES" | "COORDINATOR_ONLINE_WINDOW_MINUTES">> {}
}
