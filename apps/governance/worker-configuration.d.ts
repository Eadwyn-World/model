/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 60b8ea2a0d59dbf0019c7055e1a238ec)
// Runtime types generated with workerd@1.20260921.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	SEED_MODE: "genesis";
	LOG_LEVEL: "info";
	GOVERNANCE_APPROVAL_QUORUM: "2";
	GOVERNANCE_REJECTION_QUORUM: "1";
	REVIEWER_AUTH: "access";
	ACCESS_TEAM_DOMAIN: "";
	ACCESS_AUD: "";
	MERGE_REVIEWS: DurableObjectNamespace<import("./src/worker/index").MergeReview>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SEED_MODE" | "LOG_LEVEL" | "GOVERNANCE_APPROVAL_QUORUM" | "GOVERNANCE_REJECTION_QUORUM" | "REVIEWER_AUTH" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD">> {}
}
