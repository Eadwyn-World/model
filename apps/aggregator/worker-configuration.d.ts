/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f64a8e0015984e383924269f80f29824)
// Runtime types generated with workerd@1.20260921.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	DELTAS: R2Bucket;
	CHECKPOINTS: R2Bucket;
	DB: D1Database;
	FEDERATION_EVENTS: Queue;
	SEED_MODE: "genesis";
	LOG_LEVEL: "info";
	...
	MERGE_RUNNER: DurableObjectNamespace<import("./src/worker/index").MergeRunnerContainer>;
	COORDINATOR_INTERNAL: Service /* entrypoint InternalApi from eadwyn-coordinator */;
	GOVERNANCE_INTERNAL: Service /* entrypoint InternalApi from eadwyn-governance */;
	MERGE_PIPELINE: Workflow<Parameters<import("./src/worker/index").MergePipeline['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "MergeRunnerContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SEED_MODE" | "LOG_LEVEL" | "AGGREGATOR_VERIFY_SIGNATURES" | "AGGREGATOR_MAX_DELTA_BYTES" | "UPLOAD_TTL_SECONDS" | "AGGREGATION_BACKEND" | "INLINE_AGGREGATION_MAX_BYTES" | "R2_DELTAS_BUCKET" | "R2_CHECKPOINTS_BUCKET" | "UPLOAD_TOKEN_SECRET" | "OPERATOR_TOKEN">> {}
}
